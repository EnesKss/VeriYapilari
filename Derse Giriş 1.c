#include <stdio.h> // printf fonksiyonunu kullanabilmek için gerekli baþlýk dosyasý
...
int main() {
    ...
    // getch(); // Eðer getch kullanmak istiyorsanýz, ilgili baþlýk dosyasýný dahil etmelisiniz.
    return 0;
}
